#import "SoundLockCredit.h"


@implementation SoundLockCreditListController

+ (NSString *)hb_specifierPlist {

    return @"SoundLockCredit";
    
}

-(void)listThatDir {
   directoryVolContent = [[NSFileManager defaultManager] contentsOfDirectoryAtPath:@"/Library/Application Support/SoundLock/VolumeSounds/" error:NULL];
}
...
// Sample sound and set
    ...
    AudioServicesCreateSystemSoundID((CFURLRef)[NSURL fileURLWithPath:[NSString stringWithFormat:@"/Library/Application Support/SoundLock/VolumeSounds/%@",value]],&soundSelected);
